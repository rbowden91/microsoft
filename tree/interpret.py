...
class Interpreter(c_ast.NodeVisitor):
    ...
    def execute(self, argv, stdin=''):
        ...
        self.id_map[-1]['argv'] = ('argv', 0)
        self.type_map[-1]['argv'] = ['*', '*', 'char']
    ...
    def visit_DeclList(self, n):
        ...
        self.type = self.type_map[-1][n.decls[0].name]
    ...
    def visit_ID(self, n):
        ...
        if self.contexts[-1] == 'assignment_lvalue':
            ...
            return type_map[n.name], id_map[n.name]
