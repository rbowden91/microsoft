...
class IDRenamer(c_ast.NodeVisitor):
    ...
    def save_id(self, n, context=None):
    ...
    def visit_Enum(self, n):
        n.name = self.save_id(n.name, context='enum')
    ...
    def visit_Struct(self, n):
        n.name = self.save_id(n.name, context='struct')
    ...
    def visit_Union(self, n):
        n.name = self.save_id(n.name, context='union')
    ...
    def visit_Enumerator(self, n):
        n.name = self.save_id(n.name, context='enum_val')
        if n.value: self.visit(n.value)
        return n

    def visit_Label(self, n):
        n.name = self.save_id(n.name, context='label')
        self.visit(n.stmt)
        return n
    ...
    def visit_IdentifierType(self, n):
        ...
        n.names = [self.save_id(i) for i in n.names]
        return n
    ...
    def visit_Typedef(self, n):
        ...
        n.name = self.save_id(n.name, context='type')
        self.visit(n.type)
        self.visiting_typedef = False
        return n
    ...
    def visit_TypeDecl(self, n):
        n.declname = self.save_id(n.declname, context='type')
        self.visit(n.type)
        return n
