...
from ..my_env.packages import pycparser
...
class Server(object):
    ...
    def process_code(self, code):
       ...
       try:
           ...
           # TODO: report some more specific error?
           raise ServerException("Failed to preprocess code: {}".format(err))
...
def create_server() -> Server:
    ...
    best_dir = os.path.join('data', 'best')
